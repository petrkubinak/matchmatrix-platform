...
class MatchMatrixAdminPanel(tk.Tk):
    ...
    def build_ui(self):
        ...
        tk.Label(
            header,
            text="▰ MATCHMATRIX ŘÍDICÍ CENTRUM V19.9",
            bg="#07040d",
            fg=PINK,
        ...
        # V19.9: stará interní pravá lišta v DENNÍ PRÁCI je skrytá.
...
""".strip()
    ...
    def safe_tree_display_value_v19_9(self, col, value, max_len=220):
        """
        V19.9 - bezpečné hodnoty pro Treeview.
    ...
    def populate_tree(self, tree, rows):
        ...
        for row in rows:
            ...
            # V19.9: do Treeview nedáváme plné dlouhé logy.
