...
class TicketStudioV3:
    def __init__(self, root: tk.Tk):
        self.root = root
        self.root.title("MatchMatrix Ticket Studio V3 fix3")
        ...
        self.viewport_var = tk.StringVar(value="desktop | unified V3 | fix3 | wider right")
    ...
    def build_header(self):
        ...
        tk.Label(
            header,
            text="jednosouborová stabilní základna • širší pravý tiket • menší spodní runtime panel • přehled tiketů",
            bg=BG,
            fg=MUTED,
            font=FONT_SMALL,
            anchor="w",
    ...
    def build_controls_panel(self, parent):
        ...
        log_wrap.pack(fill="both", expand=False, padx=10, pady=(0, 10))
        self.runtime_text = tk.Text(log_wrap, height=6, bg=CARD_2, fg=TEXT, insertbackground=TEXT, wrap="word", relief="flat", font=FONT_MONO)
