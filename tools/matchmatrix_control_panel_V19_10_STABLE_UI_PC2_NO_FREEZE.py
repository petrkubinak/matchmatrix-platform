...
class MatchMatrixAdminPanel(tk.Tk):
    ...
    def build_ui(self):
        ...
        tk.Label(
            header,
            text="▰ MATCHMATRIX ŘÍDICÍ CENTRUM V19.10",
            bg="#07040d",
            fg=PINK,
...
Další termín: {h.get('next_target_date') or '-'}"""
    ...
    def on_pc2_action_card_select(self, event=None):
        """
        V19.10 - bezpečná synchronizace výběru PC2 řádků.
...
""".strip()
    ...
    def show_tab(self, name):
        ...
        if name == "PC2 COMMAND":
            # V19.10: načti denní práci až po překreslení UI, aby Windows neoznačil panel jako Neodpovídá.
