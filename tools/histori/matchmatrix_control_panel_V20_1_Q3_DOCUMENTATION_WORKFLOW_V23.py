...
"""
    ...
    def documentation_open_a23_translation_proposal(self):
        path=getattr(self,"documentation_workflow_a23_translation_proposal",None)
        if not path or not os.path.isfile(path):
            messagebox.showwarning(
                "A23 – návrh MM-REF-001",
                "Pracovní návrh MM-REF-001 nebyl nalezen.\n\n"
                f"Cesta: {path or '-'}"
            )
            return
        try:
            ...
            messagebox.showerror("A23 – návrh MM-REF-001",f"Soubor se nepodařilo otevřít:\n\n{exc}")


    def documentation_open_a23_explanation_proposal(self):
        path=getattr(self,"documentation_workflow_a23_explanation_proposal",None)
        if not path or not os.path.isfile(path):
            messagebox.showwarning(
                "A23 – návrh MM-REF-002",
                "Pracovní návrh MM-REF-002 nebyl nalezen.\n\n"
                f"Cesta: {path or '-'}"
            )
            return
        try:
            ...
            messagebox.showerror("A23 – návrh MM-REF-002",f"Soubor se nepodařilo otevřít:\n\n{exc}")
