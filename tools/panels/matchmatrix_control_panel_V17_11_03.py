"""
MATCHMATRIX CONTROL PANEL V17.11.03
========================================================
...
class MatchMatrixAdminPanel(tk.Tk):
    ...
    def __init__(self):
        ...
        self.title(
            "MATCHMATRIX OPS PANEL V17.11.03 CZ"
        )
...
""",
    ...
    def load_coverage_progress(self):
        ...
        CO TO JE:
        - Načte přehled dokončenosti sportů z ops.v_sport_completion_dashboard_v1.
        ...
        SELECT
            ...
            top_priority_rank,
            recommended_focus
        FROM ops.v_sport_completion_dashboard_v1
        ORDER BY
