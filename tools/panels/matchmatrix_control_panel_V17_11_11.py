...
# V17.11.11: klidnější fialový vzhled - důležité stavy zůstanou vidět, běžné prvky jsou ztlumené.
...
class MatchMatrixAdminPanel(tk.Tk):
    ...
    def __init__(self):
        ...
        self.title(
            "MATCHMATRIX OPS PANEL V17.11.11 CZ"
        )
