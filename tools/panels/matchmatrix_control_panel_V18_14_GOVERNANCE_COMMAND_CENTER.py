"""
MATCHMATRIX CONTROL PANEL V18.14 GOVERNANCE COMMAND CENTER
========================================================
...
V18.14:
- napojení nové živé Governance vrstvy 18_5_A až 18_5_D,
- Governance tab nově ukazuje: KPI, detail oblastí, runtime audit a DB object registry,
- zachován responzivní command center z V18.13,
- zdroje: ops.v_governance_summary_kpi_v1, ops.v_governance_panel_detail_v1, ops.v_governance_dashboard_v1.
"""
...
class MatchMatrixAdminPanel(tk.Tk):
    ...
    def __init__(self):
        ...
        self.title(
            "MATCHMATRIX OPS PANEL V18.14 GOVERNANCE COMMAND CENTER CZ"
        )
