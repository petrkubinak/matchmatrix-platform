...
class MatchMatrixPanelV13:
    def __init__(self, root: tk.Tk):
        self.root = root
        self.root.title("TicketMatrixPlatform Mission Control V13 FIX2")
        ...
        self.log_write("V14 načten: layer-aware config + CORE safe flow + PEOPLE provider/run_group mapping.")
    ...
    def run_people_v22(self) -> None:
        ...
        # V14: selected_run_group použijeme jen pokud vypadá jako PEOPLE run_group.
        # Jinak použijeme centrální SPORT_LAYER_CONFIG.
        if selected_run_group and "PEOPLE" in selected_run_group.upper():
            run_group = selected_run_group
            self.log_write(f"PEOPLE run_group převzat z panelu: {run_group}")
        else:
            run_group = configured_run_group
            if selected_run_group:
                self.log_write(
                    f"Vybraný run_group '{selected_run_group}' není PEOPLE run_group; používám {run_group}."
                )
