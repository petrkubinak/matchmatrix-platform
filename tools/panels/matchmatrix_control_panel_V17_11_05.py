"""
MATCHMATRIX CONTROL PANEL V17.11.05
========================================================
...
class MatchMatrixAdminPanel(tk.Tk):
    ...
    def __init__(self):
        ...
        self.title(
            "MATCHMATRIX OPS PANEL V17.11.05 CZ"
        )
    ...
    def build_ui(self):
        ...
        # V17.11.05: PEOPLE PIPELINE audit.
        # CO TO JE:
        # - Přehled RAW -> staging -> public hráčů podle provideru a sportu.
        # K ČEMU TO JE:
        # - Hned vidíme, které PEOPLE vrstvy čekají na parser, merge nebo jsou hotové.
        tab_people_pipeline.columnconfigure(0, weight=1)
        tab_people_pipeline.rowconfigure(0, weight=1)

        self.people_pipeline_tree = self.create_section(
            tab_people_pipeline, "👥 PEOPLE PIPELINE AUDIT", 0, 0
        )
...
""",
    ...
    def load_autonomous_ops_brain(self):
        ...
        CO TO JE:
        - Načte rozhodovací view ops.v_autonomous_ops_brain_v4.
    ...
    def load_people_pipeline(self):
        ...
        CO TO JE:
        - Načte ops.v_people_pipeline_audit_v1.

        K ČEMU TO JE:
        - Panel ukáže RAW payloady, staging hráče, public hráče, provider mapy a coverage.
        - CK je po dnešku READY: 236 staging/public/map = 100 %.

        KDE TO UVIDÍME:
        - PEOPLE PIPELINE -> PEOPLE PIPELINE AUDIT.
        """
        ...
        ORDER BY
            CASE people_status
                WHEN 'READY' THEN 1
                WHEN 'RAW_PENDING_PARSE' THEN 2
                WHEN 'READY_FOR_MERGE' THEN 3
                WHEN 'HAS_ERRORS' THEN 4
                ELSE 9
            END,
            sport_code,
            provider;
