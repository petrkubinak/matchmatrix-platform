"""
MATCHMATRIX CONTROL PANEL V17.10.04
========================================================
...
class MatchMatrixAdminPanel(tk.Tk):
    ...
    def __init__(self):
        ...
        self.title(
            "MATCHMATRIX OPS PANEL V17.10.04 CZ"
        )
    ...
    def build_ui(self):
        ...
        # =========================================================
        # STAV PROJEKTU - V17.10.04
        # =========================================================
        # CO TO JE:
        # - Horní projektový přehled dokončenosti hlavních vrstev.
        # - V17.10.04 mění samostatné progress bary na jeden společný
        #   kompaktní graf vývoje v čase.
        #
        # K ČEMU TO JE:
        # - Aby panel ukazoval nejen aktuální procenta, ale i směr vývoje.
        # - Aby se zároveň zmenšily KPI karty a zůstalo více místa pro tabulky.
        #
        # KDE TO UVIDÍME:
        ...
        project_title = tk.Label(
            project_frame,
            text="📈 STAV PROJEKTU  |  VÝVOJ VRSTEV V ČASE",
            bg="#0d0015",
            fg=PINK,
