"""
MATCHMATRIX CONTROL PANEL V17.11.07
========================================================
...
# V17.11.07: jemnější fialový vzhled - důležité stavy se zvýrazní, zbytek je klidnější.
...
class MatchMatrixAdminPanel(tk.Tk):
    ...
    def __init__(self):
        ...
        self.title(
            "MATCHMATRIX OPS PANEL V17.11.07 CZ"
        )
...
""",
    ...
    def load_harvest_dashboard(self):
        ...
        layers_sql = """
        SELECT
            'PEOPLE' AS layer_name,
            sport_code,
            sport_name,
            people_readiness_score AS readiness_score,
        ...
        SELECT
            ...
            sport_code,
            sport_name,
            media_readiness_score AS readiness_score,
        ...
        SELECT
            ...
            sport_code,
            sport_name,
            odds_readiness_score AS readiness_score,
