...
class MatchMatrixPanelV13:
    def __init__(self, root: tk.Tk):
        self.root = root
        self.root.title("TicketMatrixPlatform Mission Control V13")
        ...
        self.log_write("V13 načten: CORE / PEOPLE / MEDIA / ODDS profily + BK unified cycle + VBS launcher ready.")
