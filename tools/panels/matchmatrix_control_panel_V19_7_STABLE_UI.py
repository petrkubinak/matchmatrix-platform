"""
MATCHMATRIX CONTROL PANEL V19.7 STABLE UI / RYCHLÉ AKCE
========================================================
...
class MatchMatrixAdminPanel(tk.Tk):
    ...
    def __init__(self):
        ...
        self.title(
            "MATCHMATRIX OPS PANEL V19.7 - STABLE UI + RYCHLÉ AKCE CZ"
        )
    ...
    def build_ui(self):
        ...
        tk.Label(
            header,
            text="▰ MATCHMATRIX ŘÍDICÍ CENTRUM V19.7",
            bg="#07040d",
            fg=PINK,
...
""".strip()
    ...
    def reflow_command_center(self):
        ...
        mode = "v19_7_stable_ui_quick_actions"
        ...
        # 4) Globální rychlé akce pod doporučením.
        # Jsou nezávislé na vybraném řádku.
        self.command_actions_panel.grid(
            row=3,
            column=0,
            columnspan=2,
            sticky="ew",
        ...
        try:
            self.command_actions_panel.columnconfigure(0, weight=1)
        except Exception:
            pass
