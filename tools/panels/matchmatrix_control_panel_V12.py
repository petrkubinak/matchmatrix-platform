...
class MatchMatrixPanelV11:
    def __init__(self, root: tk.Tk):
        self.root = root
        self.root.title("TicketMatrixPlatform Mission Control V12")
        ...
        self.log_write("V12 načten: compact + responsive + PEOPLE V2.2 + BK CORE parsers runner.")
