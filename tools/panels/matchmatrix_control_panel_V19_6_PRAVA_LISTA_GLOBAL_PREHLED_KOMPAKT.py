"""
MATCHMATRIX CONTROL PANEL V19.6 PRAVÁ AKČNÍ LIŠTA / KOMPAKTNÍ PŘEHLED
========================================================
...
class MatchMatrixAdminPanel(tk.Tk):
    ...
    def __init__(self):
        ...
        self.title(
            "MATCHMATRIX OPS PANEL V19.6 - PRAVÁ AKČNÍ LIŠTA + KOMPAKTNÍ PŘEHLED CZ"
        )
    ...
    def build_ui(self):
        ...
        tk.Label(
            header,
            text="▰ MATCHMATRIX ŘÍDICÍ CENTRUM V19.6",
            bg="#07040d",
            fg=PINK,
        ...
        # =========================================================
        # V19.6 - GLOBÁLNÍ PRAVÁ AKČNÍ LIŠTA
        # =========================================================
        # CO TO JE:
        # - Pravý ovládací sloupec naproti levé navigaci.
        # - Je dostupný po celé výšce denní práce, ne jen uvnitř jedné tabulky.
        # - Střed panelu má díky tomu více místa pro obsah a akce jsou vždy na stejném místě.
        try:
        ...
        self.global_pc2_selected_action_label = tk.Label(
            self.global_pc2_action_side,
            text="Vyber řádek vlevo a použij akci.",
            bg="#100918",
            fg="#cdb7df",
        ...
        # V19.6: stará interní pravá lišta v DENNÍ PRÁCI je skrytá.
...
""".strip()
    ...
    def reflow_command_center(self):
        """
        V19.6 - KOMPAKTNÍ PŘEHLED

        CO TO JE:
        - Horní přehled už neobsahuje rychlé akce.
        - 1. řádek: KPI.
        - 2. řádek: stav hlavních oblastí.
        - 3. řádek: DNEŠNÍ PRIORITA a AI DOPORUČENÍ vedle sebe.

        K ČEMU TO JE:
        - PŘEHLED je informativní dashboard.
        - Akce jsou stále vpravo v globální akční liště, stejně jako v DENNÍ PRÁCI.
        """
        ...
        self.command_middle_panel.grid(row=0, column=0, columnspan=2, sticky="ew", padx=8, pady=(5, 2))

        # 2) Stav hlavních oblastí jako jeden kompaktní řádek.
        self.command_metrics_panel.grid(row=1, column=0, columnspan=2, sticky="ew", padx=8, pady=(2, 2))

        # 3) Dnešní priorita a AI doporučení vedle sebe.
        self.priority_bar.grid(row=2, column=0, columnspan=2, sticky="ew", padx=8, pady=(2, 6))
        try:
            ...
            self.today_priority_text.master.grid(row=1, column=0, sticky="nsew", padx=(0, 4), pady=3)
            self.ai_recommendation_text.master.grid(row=1, column=1, sticky="nsew", padx=(4, 0), pady=3)
        except Exception:
            pass

        # Rychlé akce v přehledu už nezobrazujeme. Jsou v pravé globální liště.
        try:
