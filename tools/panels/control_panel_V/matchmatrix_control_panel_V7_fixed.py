...
BATCH_RUNNER = str(PROJECT_ROOT / "workers" / "run_ingest_planner_jobs.py")
...
class MatchMatrixPanelV7:
    ...
    def build_log_area(self, parent) -> None:
        ...
        live_wrap = ttk.LabelFrame(parent, text="Live stav běhu", style="MM.TLabelframe", padding=8)
        live_wrap.grid(row=0, column=0, sticky="ew", pady=(0, 8))
        ...
        log_wrap = ttk.LabelFrame(parent, text="Log běhu / průběh stahování", style="MM.TLabelframe", padding=8)
