...
class MatchMatrixAdminPanel(tk.Tk):
    ...
    def __init__(self):
        ...
        self.title(
            "MATCHMATRIX OPS PANEL V17.10.01 CZ"
        )
    ...
    def build_ui(self):
        ...
        #
        # JAK SE TO VYUŽIJE:
        # - Později se hodnoty napojí na OPS tabulky a budou ukazovat reálné %
        #   dokončenosti CORE / PEOPLE / MEDIA / ODDS.
