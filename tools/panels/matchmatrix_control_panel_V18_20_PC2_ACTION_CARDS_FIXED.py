"""
MATCHMATRIX CONTROL PANEL V18.20 PC2 ACTION BUTTONS
========================================================
...
class MatchMatrixAdminPanel(tk.Tk):
    ...
    def __init__(self):
        ...
        self.title(
            "MATCHMATRIX OPS PANEL V18.20 PC2 ACTION CARDS FIXED CZ"
        )
...
Další termín: {h.get('next_target_date') or '-'}"""
    ...
    def on_pc2_action_card_select(self, event=None):
        """
        V18.20 - klik na akční kartu synchronizuje výběr s hlavní PC2 frontou.
        """
        try:
