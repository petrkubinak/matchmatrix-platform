"""
MATCHMATRIX CONTROL PANEL V17.10.03
========================================================
...
class MatchMatrixAdminPanel(tk.Tk):
    ...
    def __init__(self):
        ...
        self.title(
            "MATCHMATRIX OPS PANEL V17.10.03 CZ"
        )
    ...
    def build_ui(self):
        ...
        # =========================================================
        # STAV PROJEKTU - V17.10.02
        # =========================================================
        # CO TO JE:
        # - Horní projektový přehled dokončenosti hlavních vrstev.
        # - V17.10.02 přidává grafické progress bary.
        #
        # K ČEMU TO JE:
        # - Aby panel neukazoval jen provoz, ale i celkový stav projektu.
        # - Aby byl na první pohled vidět průběh CORE / PEOPLE / MEDIA / ODDS.
        #
        # KDE TO UVIDÍME:
        # - Přímo pod hlavní horní lištou panelu.
        #
        # JAK SE TO VYUŽIJE:
        # - Teď jsou hodnoty statické pro ověření vzhledu.
        # - V další verzi je napojíme na OPS tabulky a historické snapshoty.
        ...
        project_title = tk.Label(
            project_frame,
            text="📈 STAV PROJEKTU  |  DOKONČENOST VRSTEV",
            bg="#0d0015",
            fg=PINK,
            font=("Segoe UI", 10, "bold")
        )
