...
class MatchMatrixAdminPanel(tk.Tk):
    ...
    def __init__(self):
        ...
        self.title(
            "MATCHMATRIX OPS PANEL V19 - DENNÍ PRÁCE / LEVÁ NAVIGACE CZ"
        )
    ...
    def build_ui(self):
        ...
        tk.Label(
            header,
            text="▰ MATCHMATRIX ŘÍDICÍ CENTRUM V19",
            bg="#07040d",
            fg=PINK,
        ...
        self.pc2_button_tree = self.create_section(
            tab_pc2_command, "🏠 DENNÍ PRÁCE – CO SPUSTIT TEĎ", 1, 0
        )

        self.pc2_kpi_tree = self.create_section(
            tab_pc2_command, "📊 STRUČNÝ STAV PC2", 1, 1
        )
        ...
        self.pc2_actions_tree = self.create_section(
            tab_pc2_command, "✅ MOŽNÉ AKCE NAD VYBRANÝM ŘÁDKEM", 3, 1
        )
