...
class MatchMatrixAdminPanel(tk.Tk):
    ...
    def __init__(self):
        ...
        self.title(
            "MATCHMATRIX OPS PANEL V18.12 FINAL COMMAND CENTER CZ"
        )
    ...
    def build_ui(self):
        ...
        # =========================================================
        # V18.12 - MATCHMATRIX FINAL COMMAND CENTER
        # =========================================================
        # CO TO JE:
        ...
        command_frame.columnconfigure(0, weight=1, minsize=130)
        command_frame.columnconfigure(1, weight=4, minsize=520)
        command_frame.columnconfigure(2, weight=1, minsize=150)
        command_frame.columnconfigure(3, weight=6, minsize=650)
        command_frame.columnconfigure(4, weight=4, minsize=420)
        ...
        self.command_total_frame.grid(row=0, column=0, sticky="nsew", padx=(8, 4), pady=7)
        ...
        self.command_total_value.pack(anchor="w", padx=8, pady=(0, 0))
        ...
        self.command_total_status.pack(anchor="w", padx=8, pady=(0, 4))
        ...
        self.command_total_bar.pack(fill="x", padx=8, pady=(0, 7))
