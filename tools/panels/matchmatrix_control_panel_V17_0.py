# MATCHMATRIX CONTROL PANEL V17.0
#
# CO TO JE:
...
# C:\Python314\python.exe tools\matchmatrix_control_panel_V17_0.py
...
FROM ops.v_safe_execution_queue_v1
ORDER BY sport_code, entity
LIMIT 100;
"""
...
class MatchMatrixPanelV170(tk.Tk):
    ...
    def __init__(self):
        ...
        self.title("MatchMatrix Control Panel V17.0")
    ...
    def run_next_scheduler_job(self):
        ...
        priority = row["execution_priority_score"]
