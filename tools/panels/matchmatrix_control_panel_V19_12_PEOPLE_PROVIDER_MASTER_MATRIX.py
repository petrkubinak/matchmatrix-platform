"""
MATCHMATRIX CONTROL PANEL V19.8 STABLE UI / RYCHLÉ AKCE VPRAVO
========================================================
...
COLUMN_LABELS.update({
    ...
    "provider_total_score": "Provider skóre",
    "provider_rating": "Rating providera",
    "primary_gap": "Hlavní gap",
    "gap_type": "Typ gapu",
    "sport_priority_score": "Priorita sportu",
    "recommended_provider_path": "Doporučená cesta",
    "pc2_work_type": "PC2 typ práce",
    "master_decision": "Master rozhodnutí",
    "sport_order": "Pořadí sportu",
})
...
class MatchMatrixAdminPanel(tk.Tk):
    ...
    def __init__(self):
        ...
        self.title(
            "MATCHMATRIX OPS PANEL V19.8 - STABLE UI + RYCHLÉ AKCE VPRAVO CZ"
        )
    ...
    def build_ui(self):
        ...
        tk.Label(
            header,
            text="▰ MATCHMATRIX ŘÍDICÍ CENTRUM V19.11",
            bg="#07040d",
            fg=PINK,
        ...
        tab_provider_matrix.rowconfigure(3, weight=1)

        self.provider_matrix_core_tree = self.create_section(
            tab_provider_matrix, "🧬 PROVIDER MATRIX - SPORT / ENTITA", 0, 0, 2
        )

        # V19.12: PEOPLE PROVIDER MASTER MATRIX
        # CO TO JE:
        # - Nová finální matice People providerů z 19_8_D.
        # K ČEMU TO JE:
        # - Ukazuje USE_NOW / USE_WHEN_PAID_ACTIVE / RESEARCH_AND_TEST / PHOTO_FALLBACK_SOURCE.
        # KDE TO UVIDÍME:
        # - PROVIDER MATRIX -> PEOPLE PROVIDER MASTER MATRIX.
        # JAK SE TO VYUŽIJE:
        # - Hlavní rozhodovací tabulka pro People providery, PC2 práci a paid plán.
        self.provider_matrix_people_master_tree = self.create_section(
            tab_provider_matrix, "👑 PEOPLE PROVIDER MASTER MATRIX", 1, 0, 2
        )

        self.provider_matrix_people_tree = self.create_section(
            tab_provider_matrix, "👥 PEOPLE MASTER MATRIX - PŮVODNÍ", 2, 0
        )

        self.provider_matrix_coverage_tree = self.create_section(
            tab_provider_matrix, "📦 PROVIDER ENTITY COVERAGE", 2, 1
        )

        self.provider_matrix_jobs_tree = self.create_section(
            tab_provider_matrix, "⚙ PROVIDER JOBS", 3, 0, 2
        )
...
Další termín: {h.get('next_target_date') or '-'}"""
    ...
    def load_provider_matrix_dashboard(self):
        ...
        SELECT
            ...
            notes,
            discovered_at
        FROM ops.v_people_provider_master_matrix_v1
        ORDER BY
            sport_order ASC,
            provider_total_score DESC;
        """
        ...
        self.populate_tree(self.provider_matrix_people_master_tree, db_query(people_master_sql))
    ...
    def load_pc2_command_center(self):
        ...
        try:
            self.after(150, lambda: self.populate_tree(self.pc2_roadmap_tree, db_query(roadmap_sql)))
