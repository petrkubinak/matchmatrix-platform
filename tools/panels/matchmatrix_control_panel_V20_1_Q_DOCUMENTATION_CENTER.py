"""
MATCHMATRIX CONTROL PANEL V20.1.Q DOCUMENTATION CENTER
========================================================
...
TAB_HELP_TEXTS = {
    ...
    "DOCUMENTATION": ("DOKUMENTACE", "Dokumentační centrum MatchMatrix. Ukazuje stav dokumentů v databázi, aktuální verze, vazby, historii stavů a importní běhy. Současně nabízí rychlé otevření hlavních dokumentačních složek a slovníku."),
}
...
class MatchMatrixAdminPanel(tk.Tk):
    ...
    def __init__(self):
        ...
        self.title(
            "MATCHMATRIX OPS PANEL V20.1.Q - DOCUMENTATION CENTER CZ"
        )
    ...
    def build_ui(self):
        ...
        tk.Label(
            header,
            text="▰ MATCHMATRIX ŘÍDICÍ CENTRUM V20.1.Q",
            bg="#07040d",
            fg=PINK,
...
# =========================================================
        ...
        tab_documentation.rowconfigure(1, weight=1)
