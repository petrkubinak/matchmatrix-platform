"""
MATCHMATRIX CONTROL PANEL V18.17 PC2 COMMAND METADATA PANEL
========================================================
...
class MatchMatrixAdminPanel(tk.Tk):
    ...
    def __init__(self):
        ...
        self.title(
            "MATCHMATRIX OPS PANEL V18.17 PC2 COMMAND METADATA PANEL CZ"
        )
...
Další termín: {h.get('next_target_date') or '-'}"""
    ...
    def start_pc2_command(self, row):
        ...
        ok, err = db_execute("""
            ...
            SET
                ...
                last_result = 'Started from OPS Panel V18.17',
                updated_at = now()
            WHERE id = %s
        ...
        thread = threading.Thread(
            ...
            args=(int(command_id), run_args, normalized_preview),
            daemon=True
        )
        thread.start()
    ...
    def run_pc2_command_thread(self, command_id, run_args, normalized_preview):
        return_code = None
        result_message = ""
