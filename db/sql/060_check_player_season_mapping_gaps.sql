...
-- Cíl:
--   Zjistit, kolik řádků ve staging player season stats naráží na chybějící mapy
-- ============================================================================
...
SELECT 'mapped_player_rows', COUNT(*)::text
FROM staging.stg_provider_player_season_stats s
...
SELECT 'mapped_team_rows', COUNT(*)::text
FROM staging.stg_provider_player_season_stats s
...
SELECT 'mapped_league_rows', COUNT(*)::text
FROM staging.stg_provider_player_season_stats s
...
SELECT 'distinct_unmapped_leagues', COUNT(*)::text
FROM (
    SELECT DISTINCT s.provider, s.external_league_id
    FROM staging.stg_provider_player_season_stats s
