...
REVIEW CASE 3
APPLY – ANTWERP × BEERSCHOT CONTROLLED MERGE V1
===============================================================================

HISTORICKÝ ZÁPAS:
- match_id: 6865
- football_data_uk
- oficiální výsledek 5:0
...
6. Historická duplicita 6865 se odstraní.
===============================================================================
*/
...
BEGIN
    ...
    IF v_review_cases <> 1 THEN
        RAISE EXCEPTION
            'APPLY_FAILED: Poslední review případ neexistuje právě jednou.';
    END IF;
...
BEGIN
    ...
    SET
        ...
        updated_at = clock_timestamp(),
        updated_by = 'BELGIUM_REVIEW_CASE_3_APPLY'
...
BEGIN
    ...
    RAISE NOTICE
        'OK DELETE APPLY: Historická duplicita 6865 odstraněna.';
END
$delete_historical$;
...
BEGIN
    ...
    IF v_review_cases <> 0 THEN
        RAISE EXCEPTION
            'APPLY_FAILED: Review případ stále existuje.';
    END IF;
...
SELECT
    'APPLY_VALIDATED – REVIEW CASE 3 PŘIPRAVEN K COMMIT'
