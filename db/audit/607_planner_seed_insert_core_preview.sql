-- =====================================================================
-- 607_planner_seed_insert_core_preview.sql
-- Insert-ready preview pro první CORE planner seed
...
seed_rows as (
    select
        'WAVE_1_CORE' as wave,
        'PLANNER_INCLUDE' as planner_decision,
...
select
    ...
    planner_priority
from seed_rows
order by planner_priority, canonical_league_name;