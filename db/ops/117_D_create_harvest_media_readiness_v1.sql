...
CO TO JE:
- Auditní view pro vyhodnocení připravenosti Media vrstvy
  na hromadný harvest dat.

K ČEMU TO JE:
- Zjišťuje kvalitu článků.
- Zjišťuje připravenost feedů.
- Kontroluje entity linking:
    liga
    tým
    hráč
    zápas
- Identifikuje nejslabší část Media vrstvy.

KDE TO UVIDÍME:
- OPS Panel
- Mission Control
- Harvest Audit Dashboard
- Budoucí Admin Web
- Automatické Audit Snapshoty

JAK SE TO VYUŽIJE:
- rozhodování o připravenosti harvestu
- kontrola kvality Media vrstvy
- řízení dalšího vývoje
- generování doporučení pro OPS
- vstup pro AI OPS Brain

ZDROJ DAT:
- public.v_media_layer_coverage
