...
# ==========================================================
# MATCHMATRIX
# UNIFIED STAGING -> PUBLIC CORE MERGE V1
#
# Kam uložit:
# C:\MatchMatrix-platform\workers\run_unified_staging_to_public_merge_v1.py
#
# Spuštění:
# python C:\MatchMatrix-platform\workers\run_unified_staging_to_public_merge_v1.py
# ==========================================================
...
def main() -> None:
    ...
    try:
        print("=== UNIFIED STAGING -> PUBLIC CORE MERGE V1 ===")
