...
"""
MATCHMATRIX WORKER
merge_mma_players_to_public_v1.py

CO TO JE:
- Merge MMA hráčů ze staging.stg_provider_players do public.players.

K ČEMU TO JE:
- Dokončí aktuální MMA PEOPLE vrstvu ze staging do public.
...
def main() -> int:
    ...
    print("=" * 80)
    print("MATCHMATRIX MMA PLAYERS MERGE TO PUBLIC V1")
    print("=" * 80)
