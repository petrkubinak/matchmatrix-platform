...
"""
MATCHMATRIX WORKER
merge_baseball_players_to_public_v1.py

CO TO JE:
- Merge BSB hráčů ze staging.stg_provider_players do public.players.

K ČEMU TO JE:
- Dokončí aktuální BSB PEOPLE vrstvu ze staging do public.
...
def merge_players(conn) -> int:
    sql = """
        ...
        WHERE s.sport_code IN ('BSB', 'baseball')
...
def main() -> int:
    ...
    print("=" * 80)
    print("MATCHMATRIX BSB PLAYERS MERGE TO PUBLIC V1")
    print("=" * 80)
    print("SPORT_ID:", SPORT_ID)
    print("SPORT   : BSB / baseball")
    print("=" * 80)
