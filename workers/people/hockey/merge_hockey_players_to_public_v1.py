...
"""
MATCHMATRIX WORKER
merge_hockey_players_to_public_v1.py

CO TO JE:
- Merge HK hráčů ze staging.stg_provider_players do public.players.

K ČEMU TO JE:
- Dokončí aktuální HK PEOPLE vrstvu ze staging do public.
...
def merge_players(conn) -> int:
    sql = """
        ...
        WHERE s.sport_code IN ('HK', 'hockey')
