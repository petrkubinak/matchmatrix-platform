...
"""
MATCHMATRIX WORKER
merge_american_football_players_to_public_v1.py

CO TO JE:
- Merge AFB hráčů ze staging.stg_provider_players do public.players.

K ČEMU TO JE:
- Dokončí aktuální AFB PEOPLE vrstvu ze staging do public.
...
SPORT_ID = 16
SPORT_CODES = ("AFB", "american_football")
...
def merge_players(conn) -> int:
    sql = """
        ...
        WHERE s.sport_code IN ('AFB', 'american_football')
...
def main() -> int:
    ...
    print("=" * 80)
    print("MATCHMATRIX AFB PLAYERS MERGE TO PUBLIC V1")
    print("=" * 80)
    print("SPORT_ID:", SPORT_ID)
    print("SPORT   : AFB / american_football")
    print("=" * 80)
