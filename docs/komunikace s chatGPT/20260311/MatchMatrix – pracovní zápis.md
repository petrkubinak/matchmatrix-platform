...
Bylo rozhodnuto zrušit původní api_* tabulky.
...
workers/run_staging_orchestrator_v1.py
...
dokončit orchestraci ingest pipeline a plnění všech stg_* tabulek.