...
if ($DoOdds) {
  ...
  & powershell -ExecutionPolicy Bypass -File ".\pull_api_football_odds.ps1" -RunId $runId -LeagueId $LeagueId -Season $Season -From $OddsFrom -To $OddsTo
}
