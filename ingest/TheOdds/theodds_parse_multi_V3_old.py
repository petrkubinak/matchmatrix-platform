...
def resolve_team_id_theodds(
    ...
    if best_name and score >= TEAM_MATCH_THRESHOLD:
        resolved_tid = (
            provider_map.get(best_name)
            or team_map.get(best_name)
            or alias_map.get(best_name)
        )
            ...
            if auto_insert_alias:
                try:
                    ...
                    try:
                        ...
                        pass
            alias_map[key] = resolved_tid
            return resolved_tid, best_name, score
...
def parse_and_insert_odds(
    ...
    for event in events:
        ...
        home_id, best_home_candidate, best_home_score = resolve_team_id_theodds(
            conn,
            provider_map,
            alias_map,
            team_map,
        ...
        away_id, best_away_candidate, best_away_score = resolve_team_id_theodds(
            conn,
            provider_map,
            alias_map,
            team_map,
...
def main():
    ...
    try:
        ...
        candidate_names = load_candidate_names(provider_map, alias_map, team_map)
