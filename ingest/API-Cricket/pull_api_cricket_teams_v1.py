# -*- coding: utf-8 -*-
"""
pull_api_cricket_teams_v1.py
---------------------------------------------------------
CRICKET teams raw pull
Tok:
    RapidAPI / Cricbuzz
...
ENDPOINT_NAME = "teams_v1_international"
ENDPOINT_PATH = "/teams/v1/international"
...
def detect_external_id(payload: Dict[str, Any]) -> Optional[str]:
    for key in ("categoryId", "teamId", "id"):
...
def main() -> int:
    ...
    print("======================================")
    print("MATCHMATRIX CRICKET TEAMS PULL")
    print("======================================")
