# -*- coding: utf-8 -*-
"""
pull_api_cricket_leagues_schedule_v1.py
---------------------------------------------------------
CRICKET leagues supplement raw pull
Endpoint:
    /schedule/v1/international

Ukládá raw payload do staging.stg_api_payloads
jako entity_type = leagues
"""
...
ENDPOINT_NAME = "schedule_v1_international"
ENDPOINT_PATH = "/schedule/v1/international"
...
def main() -> int:
    ...
    print("======================================")
    print("MATCHMATRIX CRICKET LEAGUES SCHEDULE PULL")
    print("======================================")
    print(f"URL  : {BASE_URL}{ENDPOINT_PATH}")
    print("HOST : cricbuzz-cricket.p.rapidapi.com")
