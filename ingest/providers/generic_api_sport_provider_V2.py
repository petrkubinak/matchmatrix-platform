...
class GenericApiSportProvider(BaseProvider):
    ...
    Používá shared PowerShell skripty pouze pro entity:
    - leagues
    - teams
    - fixtures

    Entity "players" zde záměrně NENÍ podporována.
    Players budou řešeni přes samostatného providera, protože
    API-Sport family pro tuto vrstvu není finální zdroj pravdy.
    """
    ...
    def dispatch(
        ...
        try:
            ...
            # aby dispatcher nemířil na neexistující script
            # a zároveň bylo jasné, že tato entita čeká na jiného providera.
            if entity == "players":
                raise ValueError(
