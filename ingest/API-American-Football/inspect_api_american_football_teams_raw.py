...
# Uprav jen tuto cestu, pokud budes chtit nacitat jiny soubor
RAW_FILE = Path(
...
def main() -> None:
    ...
    print("=" * 70)
    print("MATCHMATRIX - INSPECT AFB TEAMS RAW")
    print("=" * 70)
    ...
    print(json.dumps(first, ensure_ascii=False, indent=2)[:8000])
    print("=" * 70)
