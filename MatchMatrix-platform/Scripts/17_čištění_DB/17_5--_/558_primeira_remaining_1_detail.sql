-- 558_primeira_remaining_1_detail.sql
-- Cíl:
-- detailně rozebrat poslední 1 Primeira Liga pair-missing případ

WITH candidate AS (
    SELECT *
    FROM (
        VALUES
            ('Casa Pia', 'Benfica', TIMESTAMP '2026-04-06 19:45:00', 588, 99)
