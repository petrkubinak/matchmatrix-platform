-- 552_verify_epl_after_all_merges.sql
-- Cíl:
-- ověřit, že všech 6 původních EPL problem cases
-- je po dnešních merge krocích dohledatelných na canonical větvích
...
WITH epl_cases AS (
    ...
    FROM (
        VALUES
            ...
            ('Crystal Palace', 'Newcastle United', TIMESTAMP '2026-04-12 13:00:00', 63, 56),
            ...
            ('Newcastle United', 'Bournemouth', TIMESTAMP '2026-04-18 14:00:00', 56, 67),
...
-- staré větve už nesmí existovat
SELECT id, name
FROM public.teams
WHERE id IN (956, 11917, 11904, 61, 64, 56)
ORDER BY id;