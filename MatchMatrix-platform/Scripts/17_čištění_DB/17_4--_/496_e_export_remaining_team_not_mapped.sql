-- 496_e_export_remaining_team_not_mapped.sql
-- Cíl:
-- vytáhnout už jen ty aliasy, které po posledním seedu pořád zůstaly v TEAM_NOT_MAPPED
