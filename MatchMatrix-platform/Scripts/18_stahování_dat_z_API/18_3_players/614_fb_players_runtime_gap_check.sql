...
-- Účel:
-- rychle zkontrolovat skutečný runtime stav FB players
-- Spouštět v DBeaveru
...
select
    ...
    count(distinct team_external_id) as distinct_team_ids
...
-- 4) player provider map pro api_football
select
    provider,
