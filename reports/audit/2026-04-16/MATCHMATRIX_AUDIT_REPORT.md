...
Datum a čas: 2026-04-16 13:48:50
...
- DELETED: MatchMatrix-platform\Scripts\18_stahování_dat_z_API\Script.sql
- MODIFIED: MatchMatrix-platform\.dbeaver\project-metadata.json
- NEW: db\sql\203_fb_teams_bridge_into_stg_provider_teams_fix.sql
- NEW: db\sql\205_fb_fixtures_bridge_into_stg_provider_fixtures_fix.sql
- NEW: db\sql\206_fb_leagues_bridge_into_stg_provider_leagues_fix.sql
- NEW: db\sql\207_update_runtime_entity_audit_fb_staging_confirmed.sql
- NEW: db\sql\208_fb_team_provider_map_audit_fix.sql
- NEW: db\sql\211_fb_team_provider_map_insert_safe_exact_unique_dedup.sql
- NEW: db\sql\212_fb_team_provider_map_remaining_unmapped_audit.sql
- NEW: db\sql\213_fb_team_provider_map_multi_match_export.sql
- NEW: db\sql\215_fix_team_alias_conflict_vitesse.sql
- NEW: db\sql\216_fb_merge_candidates_existence_audit.sql
- NEW: db\sql\217_fb_team_merge_batch_1_current.sql
- NEW: db\sql\218_fk_move_before_merge_almeria.sql
- NEW: db\sql\219_fk_move_before_merge_almeria_league_standings.sql
- NEW: db\sql\220_fk_move_almeria_league_standings_execute.sql
- NEW: db\sql\221_premerge_fk_and_alias_cleanup_almeria_api_sport.sql
- NEW: db\sql\222_premerge_fk_and_alias_cleanup_cambuur.sql
- NEW: db\sql\223_fb_team_provider_map_insert_safe_rerun_after_merges.sql
- NEW: db\sql\224_premerge_fk_and_alias_cleanup_batch_crotone_eibar_empoli.sql
...
?? db/sql/203_fb_teams_bridge_into_stg_provider_teams_fix.sql
?? db/sql/205_fb_fixtures_bridge_into_stg_provider_fixtures_fix.sql
?? db/sql/206_fb_leagues_bridge_into_stg_provider_leagues_fix.sql
?? db/sql/207_update_runtime_entity_audit_fb_staging_confirmed.sql
?? db/sql/208_fb_team_provider_map_audit_fix.sql
?? db/sql/211_fb_team_provider_map_insert_safe_exact_unique_dedup.sql
?? db/sql/212_fb_team_provider_map_remaining_unmapped_audit.sql
?? db/sql/213_fb_team_provider_map_multi_match_export.sql
?? db/sql/215_fix_team_alias_conflict_vitesse.sql
?? db/sql/216_fb_merge_candidates_existence_audit.sql
?? db/sql/217_fb_team_merge_batch_1_current.sql
?? db/sql/218_fk_move_before_merge_almeria.sql
?? db/sql/219_fk_move_before_merge_almeria_league_standings.sql
?? db/sql/220_fk_move_almeria_league_standings_execute.sql
?? db/sql/221_premerge_fk_and_alias_cleanup_almeria_api_sport.sql
?? db/sql/222_premerge_fk_and_alias_cleanup_cambuur.sql
?? db/sql/223_fb_team_provider_map_insert_safe_rerun_after_merges.sql
?? db/sql/224_premerge_fk_and_alias_cleanup_batch_crotone_eibar_empoli.sql
?? db/sql/225_premerge_fk_and_alias_cleanup_batch_lens_reims_brest.sql
?? db/sql/226_premerge_fk_and_alias_cleanup_batch_salernitana_sampdoria_vizela.sql
?? db/sql/227_premerge_fk_and_alias_cleanup_batch_willem_pec_vitesse.sql
?? db/sql/228_premerge_fk_and_alias_cleanup_batch_laspalmas_leganes_monza.sql
?? db/sql/229_premerge_fk_and_alias_cleanup_batch_5.sql
?? db/sql/230_premerge_fk_and_alias_cleanup_batch_5_next.sql
?? db/sql/231_premerge_fk_and_alias_cleanup_batch_5_next.sql
?? db/sql/232_premerge_fk_and_alias_cleanup_batch_10.sql
?? db/sql/233_premerge_fk_and_alias_cleanup_batch_10_next.sql
?? db/sql/234_premerge_fk_and_alias_cleanup_batch_10_next.sql
?? db/sql/235_premerge_fk_and_alias_cleanup_batch_10_next.sql
?? db/sql/237_export_current_multi_match_candidates.sql
?? db/sql/239_premerge_fk_and_alias_cleanup_batch_10_next.sql
?? db/sql/240_premerge_fk_and_alias_cleanup_batch_10_next.sql
?? db/sql/241_premerge_fk_and_alias_cleanup_batch_20_next.sql
?? db/sql/242_premerge_fk_and_alias_cleanup_batch_20_next.sql
?? db/sql/243_premerge_fk_and_alias_cleanup_batch_20_next.sql
?? db/sql/244_premerge_fk_and_alias_cleanup_batch_20_next.sql
?? db/sql/245_premerge_fk_and_alias_cleanup_batch_20_next.sql
?? db/sql/246_premerge_fk_and_alias_cleanup_batch_20_next.sql
?? db/sql/247_premerge_fk_and_alias_cleanup_batch_20_next.sql
?? db/sql/248_premerge_fk_and_alias_cleanup_batch_20_next.sql
?? db/sql/249_premerge_fk_and_alias_cleanup_batch_20_next.sql
?? db/sql/250_premerge_fk_and_alias_cleanup_batch_20_next.sql
?? db/sql/251_export_final_5_multi_match.sql
?? db/sql/252_premerge_fk_and_alias_cleanup_final_pairs.sql
?? db/sql/253_premerge_fk_and_alias_cleanup_final_triples.sql
?? db/sql/254_export_should_now_be_mappable_and_no_exact_match.sql
?? db/sql/255_insert_should_now_be_mappable.sql
?? db/sql/257_export_duplicate_provider_id_cases.sql
?? db/sql/258_export_no_exact_match_buckets.sql
?? db/sql/259_normalize_encoding_preview.sql
?? db/sql/260_normalize_team_name_function.sql
?? db/sql/262_normalize_team_name_function_unaccent.sql
?? db/sql/263_test_normalization_unaccent.sql
?? db/sql/264_export_encoding_candidates_against_canonical.sql
?? db/sql/265_safe_exact_normalized_matches.sql
?? db/sql/266_insert_safe_normalized_matches.sql
?? db/sql/267_safe_normalized_matches_only_from_current_no_exact.sql
?? db/sql/268_no_exact_match_bucket_counts.sql
?? db/sql/269_export_club_work_queue_only.sql
?? db/sql/270_encoding_alias_mapping_batch.sql
?? db/sql/271_export_other_club_top_candidates.sql
?? db/sql/272_find_canonical_candidates_for_encoding_batch.sql
?? db/sql/273_encoding_alias_mapping_safe_only.sql
?? db/sql/274_direct_provider_map_insert_safe_encoding_cases.sql
?? db/sql/275_export_remaining_encoding_cases.sql
?? db/sql/276_find_canonical_candidates_for_remaining_encoding_cases.sql
?? db/sql/277_direct_provider_map_insert_safe_encoding_cases_next.sql
?? db/sql/279_preview_other_club_matches_like.sql
?? db/sql/280_manual_lookup_other_club_batch_10.sql
?? db/sql/281_other_club_cases_presence_check.sql
?? db/sql/282_export_missing_canonical_clubs_from_other_cases.sql
?? db/sql/283_show_public_teams_columns.sql
?? db/sql/285_export_remaining_should_now_be_mappable.sql
?? db/sql/286_note_duplicate_provider_id_arsenal.sql
?? db/sql/287_insert_missing_canonical_clubs_batch_2.sql
?? db/sql/288_insert_missing_canonical_clubs_batch_3.sql
?? db/sql/289_insert_missing_canonical_clubs_batch_4.sql
?? db/sql/290_insert_missing_canonical_clubs_batch_5.sql
?? db/sql/291_insert_missing_canonical_clubs_batch_6.sql
?? db/sql/292_insert_missing_canonical_clubs_batch_70.sql
?? db/sql/293_insert_missing_canonical_clubs_batch_70_next.sql
?? db/sql/294_insert_missing_canonical_clubs_batch_final_95.sql
?? db/sql/295_fb_team_cleanup_final_note.sql
...
?? reports/audit/system_tree_2026-04-16_134848.txt
