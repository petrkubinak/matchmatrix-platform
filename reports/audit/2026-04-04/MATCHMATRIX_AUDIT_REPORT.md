...
Datum a čas: 2026-04-04 23:51:00
...
- MODIFIED: tools\matchmatrix_control_panel_V11.py
- MODIFIED: workers\theodds_matching_v3.py
- NEW: db\sql\527_world_cup_Congo_safe_merges.sql
- NEW: MatchMatrix-platform\Scripts\17_čištění_DB\527_world_cup_Congo_safe_merges.sql
- NEW: unmatched_theodds_168.csv
- NEW: unmatched_theodds_168.sql
- NEW: unmatched_theodds_169.csv
- NEW: unmatched_theodds_169.sql
- NEW: unmatched_theodds_170.csv
- NEW: unmatched_theodds_170.sql
- NEW: unmatched_theodds_171.csv
- NEW: unmatched_theodds_171.sql
- NEW: unmatched_theodds_172.csv
- NEW: unmatched_theodds_172.sql
