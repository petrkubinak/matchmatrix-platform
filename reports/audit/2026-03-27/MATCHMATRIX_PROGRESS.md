...
Celkem bylo projito 1378 sledovaných souborů.

Ve srovnání s minulým auditem:
- bylo přidáno 72 nových souborů
- u 4 souborů proběhla úprava
- 5 souborů bylo odstraněno
