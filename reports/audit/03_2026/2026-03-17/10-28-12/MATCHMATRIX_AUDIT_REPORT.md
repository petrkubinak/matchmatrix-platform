# MatchMatrix – technický audit

Datum a čas: 2026-03-17 10:28:13
...
## Top změny
- NEW: backups\postgres_dumps\dump-matchmatrix-202602131248.sql
- NEW: db\audit\079_audit_player_season_statistics_report_v1.sql
- NEW: db\audit\080_debug_player_stats_merge_mapping_v1.sql
- NEW: db\audit\cleanup_player_season_stats_scope_95_2024_v1.sql
- NEW: db\checks\001_daily_ingest_healthcheck.sql
- NEW: db\checks\011_check_new_core_tables.sql
- NEW: db\checks\013_check_players_coverage.sql
- NEW: db\checks\MATCHMATRIX_DAILY_STATUS.sql
- NEW: db\checks\MATCHMATRIX_WEEKLY_DIAGNOSTICS.sql
- NEW: db\migrations\000_create_schema_migrations.sql
- NEW: db\migrations\001_create_table_seasons.sql
- NEW: db\migrations\002_create_table_players.sql
- NEW: db\migrations\003_create_table_player_provider_map.sql
- NEW: db\migrations\004_create_table_lineups.sql
- NEW: db\migrations\005_create_table_injuries.sql
- NEW: db\migrations\006_create_table_content_sources.sql
- NEW: db\migrations\007_create_table_articles.sql
- NEW: db\migrations\008_create_table_article_team_map.sql
- NEW: db\migrations\009_create_table_article_league_map.sql
- NEW: db\migrations\010_create_table_article_match_map.sql

## Git
- Branch: main
- Last commit: 0e00769 | 2026-03-11 20:22:35 +0100 | Initial MatchMatrix setup (Docker + ingest + reports)
```
...
?? ops_admin/panel_matchmatrix_audit_v4.py
?? ops_admin/panel_matchmatrix_audit_v5.py
...
## Databáze
- Chyba DB: column "provider" does not exist
