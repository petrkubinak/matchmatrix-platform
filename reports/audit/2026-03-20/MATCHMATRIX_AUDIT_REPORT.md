...
Datum a čas: 2026-03-20 10:23:14
...
- NEW: db\checks\111_audit_missing_multisport_coverage.sql
- NEW: db\checks\114_check_multisport_coverage_after_seed.sql
- NEW: db\checks\115_audit_ingest_targets_multisport.sql
- NEW: db\checks\116_audit_ingest_targets_sport_code_mapping.sql
- NEW: db\checks\118_recheck_ingest_targets_multisport.sql
- NEW: db\checks\119_audit_football_ingest_targets_by_run_group.sql
- NEW: db\checks\120_audit_bk_hk_ingest_targets_by_run_group.sql
- NEW: db\checks\121_preview_bk_hk_targets.sql
- NEW: db\checks\122_preview_hk_targets.sql
- NEW: db\checks\123_shortlist_bk_hk_senior_primary_targets.sql
- NEW: db\checks\124_preview_bk_maintenance_top_candidates.sql
- NEW: db\checks\125_preview_bk_nbl_candidates.sql
- NEW: db\checks\126_resolve_bk_nbl_league_names.sql
- NEW: db\checks\127_preview_bk_china_candidates.sql
- NEW: db\checks\129_preview_hk_maintenance_top_candidates.sql
- NEW: db\checks\130_resolve_hk_extraliga_candidates.sql
- NEW: db\checks\132_audit_top_run_groups_fb_bk_hk.sql
- NEW: db\checks\133_preview_top_run_groups_fb_bk_hk.sql
- NEW: db\checks\135_audit_v_top_ingest_targets_by_provider.sql
- NEW: db\checks\137_audit_missing_bk_top_jobs.sql
...
?? MatchMatrix-platform/Scripts/12_multisport/
?? MatchMatrix-platform/Scripts/13_multisport_ingest/
...
?? db/checks/122_preview_hk_targets.sql
?? db/checks/123_shortlist_bk_hk_senior_primary_targets.sql
?? db/checks/124_preview_bk_maintenance_top_candidates.sql
?? db/checks/125_preview_bk_nbl_candidates.sql
?? db/checks/126_resolve_bk_nbl_league_names.sql
?? db/checks/127_preview_bk_china_candidates.sql
?? db/checks/129_preview_hk_maintenance_top_candidates.sql
?? db/checks/130_resolve_hk_extraliga_candidates.sql
?? db/checks/132_audit_top_run_groups_fb_bk_hk.sql
?? db/checks/133_preview_top_run_groups_fb_bk_hk.sql
?? db/checks/135_audit_v_top_ingest_targets_by_provider.sql
?? db/checks/137_audit_missing_bk_top_jobs.sql
?? db/checks/139_recheck_top_ingest_jobs.sql
?? db/checks/140_count_top_ingest_jobs.sql
?? db/checks/146_audit_ops_budget_runtime_objects.sql
...
?? db/migrations/100_rebuild_player_season_statistics.sql
?? db/migrations/101_extend_existing_multisport_core.sql
?? db/migrations/102_extend_existing_coach_core.sql
?? db/migrations/103_create_coach_provider_map.sql
?? db/migrations/104_extend_stg_provider_coaches.sql
?? db/migrations/105_create_ops_sport_entity_rules.sql
?? db/migrations/106_create_ops_sport_dimension_rules.sql
?? db/migrations/107_create_ops_provider_sport_matrix.sql
?? db/migrations/108_seed_ops_ingest_entity_plan_multisport.sql
?? db/migrations/112_seed_missing_sport_entity_rules.sql
?? db/migrations/113_seed_missing_ingest_entity_plan_from_rules.sql
?? db/migrations/117_fix_ingest_targets_sport_codes.sql
?? db/migrations/128_seed_bk_maintenance_top.sql
?? db/migrations/131_seed_hk_maintenance_top.sql
?? db/migrations/138_seed_api_sport_bk_ingest_entity_plan.sql
?? db/ops/
?? db/queries/
...
?? db/sql/099_merge_player_season_stats_final_target_key_fix.sql
?? "db/sql/102a_zjis\305\241t\304\233n\303\255_sruktury_tren\303\251rsk\303\275ch_tabulek.sql"
?? db/sql/114_sql_players_pipeline_audit_queries.sql
?? db/sql/Script-14.sql
?? db/views/090_v_fd_matches_week_ui.sql
?? db/views/109_create_v_ops_ingest_overview.sql
?? db/views/134_create_v_ops_top_ingest_targets.sql
?? db/views/136_create_v_ops_top_ingest_jobs.sql
?? db/views/141_create_v_ops_top_ingest_jobs_ordered.sql
?? db/views/142_create_v_ops_top_ingest_jobs_runnable.sql
?? db/views/143_create_v_ops_top_ingest_jobs_test_mode.sql
?? db/views/144_fix_v_ops_top_ingest_jobs_test_mode_no_odds.sql
?? db/views/145_create_v_ops_top_ingest_jobs_full_mode.sql
?? docs/GitHub/
...
?? "docs/komunikace s chatGPT/20260320/"
?? docs/visual/
...
?? "ops_admin/TicketMatrix Platform.bat"
...
?? "tools/8. Doporu\304\215en\303\275 b\304\233\305\276n\303\275 postup.txt"
?? "tools/Co d\304\233laj\303\255 tla\304\215\303\255tka v panelu V7.txt"
?? tools/matchmatrix_control_panel_V3.py
?? tools/matchmatrix_control_panel_V4.py
?? tools/matchmatrix_control_panel_V5.py
?? tools/matchmatrix_control_panel_V6.py
?? tools/matchmatrix_control_panel_V7.py
?? tools/run_matchmatrix_control_panel_V3.bat
?? tools/run_matchmatrix_control_panel_V5.vbs
?? tools/run_matchmatrix_control_panel_V6.vbs
?? tools/run_matchmatrix_control_panel_V7.vbs
...
?? workers/run_players_pipeline_full_v1.py
