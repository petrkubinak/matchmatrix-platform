...
- Další krok je:
  - navrhnout a otestovat CK public merge pro:
    - leagues
    - teams
    - fixtures

### 12.3 Co teď neřešit
- neřešit zatím CK players
- neřešit zatím CK stats endpointy
- neřešit zatím CK news
- neřešit zatím downstream entity
- nejdřív uzavřít CK public merge

### 12.4 CK core pipeline je potvrzena end-to-end:
  - fixtures CONFIRMED
  - leagues CONFIRMED
  - teams CONFIRMED

### 12.5 CK jede přes nový generický model:
  - staging.stg_api_payloads
  - staging.stg_provider_fixtures
  - staging.stg_provider_leagues
  - staging.stg_provider_teams
...
### 12.6 CK audit:
  - ops.runtime_entity_audit = CONFIRMED
  - ops.sport_completion_audit = CONFIRMED / READY
